    ...
    public partial class CreatedDatabase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Produtc", t => t.ProductId, cascadeDelete: true)
                .Index(t => t.OrderId)
                .Index(t => t.ProductId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_OrderDetail", "ProductId", "dbo.Produtc");
            DropForeignKey("dbo.Produtc", "ProductCategoryId", "dbo.ProductCategory");
            ...
            DropIndex("dbo.Produtc", new[] { "ProductCategoryId" });
